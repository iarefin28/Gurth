 ...
 */
  ...
  function handleLoadAchievements(event) {
    ...
    <Box sx={{ display: 'flex' }}>
      ...
      >
        <Box justifyContent="center" sx={{ display: "flex", flexDirection: "row" }}>
          <Box>
            <IconButton sx={{ color: "white" }} onClick={handleLogout}><LogoutIcon/></IconButton>
          </Box>
          <Box>
            <DateTime />
          </Box>
        ...
        <IconButton sx={{ color: "white" }} onClick={handleLoadHome}><HomeIcon/></IconButton>
        <IconButton sx={{ color: "white" }} onClick={handleLoadQuests}><AssignmentIcon/></IconButton>
        <IconButton sx={{ color: "white" }} onClick={handleLoadFitness}><FitnessCenterIcon/></IconButton>
        <IconButton sx={{ color: "white" }} onClick={handleLoadDiary}><MenuBookIcon/></IconButton>
        <IconButton sx={{ color: "white" }} onClick={handleLoadAchievements}><CheckIcon/></IconButton>
        <IconButton sx={{ color: "white" }} disabled="true"><WorkIcon/></IconButton>
        <IconButton sx={{ color: "white" }} disabled="true"><BackpackIcon/></IconButton>
      </Drawer>
    </Box>
  );
}