...
export default function HomeScreen() {
    ...
    return (
        <Box sx={{backgroundImage: "linear-gradient(180deg, #000000 0%, #2c3e50 74%)"}}>
    		<CssBaseline/>
			<Dashboard></Dashboard>
        	<Box sx={{width: `calc(100% - ${drawerWidth}px)`, ml: `${drawerWidth}px`}}>
                ...
                <Box sx={{display: "flex", flexDirection: "row"}}>
                    <Box sx={{display: "flex", flexDirection: "column", alignItems: "center", mt: "72px", backgroundColor: "transparent", width: "50%", height: `calc(100vh - 72px)`, overflow: "auto"}}>
                        <ToDoList></ToDoList>
                    </Box>
                    <Box sx={{display: "flex", flexDirection: "column", mt: "72px", backgroundColor: "transparent", width: "50%", height: `calc(100vh - 72px)`}}>
                        <Box sx={{display: "flex", flexDirection: "column", backgroundColor: "white", width: "100%", minHeight: "50%", borderTop: 0, borderRight: 0, borderLeft: 1, borderBottom: 1, borderColor: "black"}}>
                            {weatherPic}
                        ...
                        <Box sx={{backgroundImage: "transparent", width: "100%", minHeight: "50%", borderTop: 0, borderRight: 0, borderLeft: 1, borderBottom: 0, borderColor: "black"}}>
                        <Box sx={{width: "100%", height: "100%", backgroundImage: 'url(' + HomeScreen1 + ')', backgroundSize: 'cover', backgroundPosition: 'center', borderLeft: 1, borderColor: 'black', display: "flex", flexDirection: "column"}}>
